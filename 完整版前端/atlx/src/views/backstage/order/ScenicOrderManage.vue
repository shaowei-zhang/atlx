<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column label="景区图片" align="center" width="80" prop="scenic.scenicImg">
        <template slot-scope="scope">
          <img :src="scope.row.scenic.scenicImg" width="50" height="50" style="border-radius: 2px"/>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    getUserList(){
      ...
      this.$axios.post('/scenicOrder/orderList',{
    ...
    delHandle(id){
      ...
      this.$axios.post('/scenicOrder/delOrder/'+dels).then(res => {
