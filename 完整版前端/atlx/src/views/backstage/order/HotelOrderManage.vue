<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column label="酒店图片" align="center" width="80" prop="hotel.hotelImg">
        <template slot-scope="scope">
          <img :src="scope.row.hotel.hotelImg" width="50" height="50" style="border-radius: 2px"/>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    getUserList(){
      this.$axios.post('/hotelOrder/orderList',{
