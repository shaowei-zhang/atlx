<template>
  <div>
    ...
    <el-row>
      <el-col :span="7" :offset="17">
        <el-form :inline="true"  class="demo-form-inline">
          <el-form-item >
            <el-input v-model="scenicInfo.scenicName" placeholder="请输入景区名称"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <el-row :gutter="20">
      <el-col :span="22">
      <div v-for="f in scenicInfo">
        <el-col :span="2" :offset="3"  style="margin-bottom: 30px">
          <router-link :to="{name:'scenicDetails',query:{setScenicName: f.scenicName}}">
            <el-image :src="f.scenicImg" style="width: 180px;height: 150px; border-radius: 4px;"></el-image>
          </router-link>
          <h3>{{f.scenicName}}</h3>
        </el-col>
      </div>
...
export default {
  ...
  methods:{
    ...
    * */
    onSubmit() {
      var scenicName=this.scenicInfo.scenicName
      //直接跳转
   ...
   * */
    ...
    scenicCarousel(){
      for(let i=0;i<8;i++){
        this.imgArr[i].id = i;
        this.imgArr[i].url = require("@/assets/images/scenicCarousel/"+(i+1)+".png")
      }
    }
  },
  //进入页面后启动定时轮询
