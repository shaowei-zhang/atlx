<template>
  <div>
    ...
    <el-row>
      <el-col :span="7" :offset="17">
        <el-form :inline="true"  class="demo-form-inline">
          <el-form-item >
            <el-input v-model="touristInfo.startName" placeholder="请输入起点或终点"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <el-row :gutter="20">
      <el-col :span="22">
      <div v-for="t in touristInfo">
        <el-col :span="2" :offset="3"  style="margin-bottom: 30px">
          <router-link :to="{name:'planDetails',query:{setStartName: t.startName}}">
            <el-image :src="t.avatar" style="width: 180px;height: 150px; border-radius: 4px;"></el-image>
          </router-link>
          <h4>{{t.startName}}</h4>
          <h5>至</h5>
          <h4>{{t.endName}}</h4>
...
export default {
  ...
  methods:{
    ...
    onSubmit() {
      var startName=this.touristInfo.startName
      //直接跳转
   ...
   * */
    ...
    touristCarousel(){
      for(let i=0;i<8;i++){
        this.imgArr[i].id = i;
        this.imgArr[i].url = require("@/assets/images/touristRoutes/"+(i+1)+".png")
      }
    }
  },
  //进入页面后启动定时轮询
