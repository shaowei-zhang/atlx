<template>
  <div>
    ...
    <el-row>
      <el-col :span="7" :offset="17">
        <el-form :inline="true"  class="demo-form-inline">
          <el-form-item >
            <el-input v-model="hotelInfo.hotelName" placeholder="请输入酒店名"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <el-row :gutter="20">
      <el-col :span="22">
      <div v-for="f in hotelInfo">
        <el-col :span="2" :offset="3"  style="margin-bottom: 30px">
          <router-link :to="{name:'hotelDetails',query:{setHotelName: f.hotelName}}">
            <el-image :src="f.hotelImg" style="width: 180px;height: 150px; border-radius: 4px;"></el-image>
          </router-link>
          <h3>{{f.hotelName}}</h3>
        </el-col>
      </div>
...
export default {
  ...
  methods:{
    ...
    * */
    onSubmit() {
      var hotelName=this.hotelInfo.hotelName
      //直接跳转
   ...
   * */
    ...
    hotelCarousel(){
      for(let i=0;i<8;i++){
        this.imgArr[i].id = i;
        this.imgArr[i].url = require("@/assets/images/hotelCarousel/"+(i+1)+".png")
      }
    }
  },
  //进入页面后启动定时轮询
